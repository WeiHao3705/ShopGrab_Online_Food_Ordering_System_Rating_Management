...
DROP TABLE Address CASCADE CONSTRAINTS; -- Note: There is no CREATE TABLE for Address below
...
CREATE TABLE Voucher (
    voucherID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE Restaurant (
    restaurantID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE MemberMembership (
    memberMembershipID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE MemberVoucher (
    memberVoucherID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE MenuItem (
    menuitemID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE DeliveryService (
    deliveryServiceID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE DeliveryRating (
    delivery_rating_id NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
...
CREATE TABLE FoodRating (
    food_rating_ID NUMBER GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
    rating_score NUMBER NOT NULL CHECK (rating_score BETWEEN 1 AND 5),
    "comment" CLOB,
    rating_date DATE DEFAULT SYSDATE NOT NULL,
    orderID NUMBER NOT NULL,
